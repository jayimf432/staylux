    ...
    <div className="max-w-xl">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold flex items-center gap-2">
            Guest Messages
            {totalUnread > 0 && (
              <Badge className="bg-primary text-white">{totalUnread}</Badge>
            )}
          </h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-20 text-muted-foreground">
          ...
          <p className="text-sm mt-1">Guest messages will appear here once they contact you.</p>
        </div>
      ) : (
        <div className="space-y-2">
          {filtered.map((convo, i) => (
            ...
            >
              {/* Host messages thread reuses the guest thread page via conversationId */}
              <Link
